...
const doubleUnderMap: Record<string, string> = {
  ...
  w: 'w̳', x: 'x̳', y: 'y̳', z: 'z̳', 'Ä': 'Ä̳̳', 'Ö': 'Ö̳̳', 'Ü': 'Ü̳̳',
  'ä': 'ä̳̳', 'ö': 'ö̳̳', 'ü': 'ü̳̳', 'ß': 'ß̳'
};

export const doubleUnderStyle: StyleDefinition = {
  name: 'Double Under',
  transform: (text: string) => text.split('').map(char => doubleUnderMap[char] || char).join('')
};
